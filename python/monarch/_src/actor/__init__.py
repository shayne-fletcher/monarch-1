...
if _in_ipython:
    os.environ.setdefault("HYPERACTOR_MESH_ENABLE_LOG_FORWARDING", "true")
    os.environ.setdefault("HYPERACTOR_MESH_ENABLE_FILE_CAPTURE", "true")
    os.environ.setdefault("HYPERACTOR_MESH_TAIL_LOG_LINES", "100")
