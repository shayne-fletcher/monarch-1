...
pub(crate) struct Labels {
    ...
    // Execution pane labels. The `{n}` placeholder in
    // `execution_more_names` is substituted with `String::replace` at
    // render time.
...
impl Labels {
    ...
    pub(crate) fn en() -> Self {
        Self {
            ...
            execution_more_names: "… {n} more endpoint names",
            error_message: "Error: ",
    ...
    pub(crate) fn zh() -> Self {
        Self {
            ...
            execution_oldest: "最早: ",
            execution_more_names: "… 还有 {n} 个端点名称",
            error_message: "错误: ",
            root_cause: "根因: ",
            failed_at: "失败时间: ",
            propagated: "传播: ",
